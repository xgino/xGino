...
- [ ] Accounting mobile app
    Flutter learning through an Accounting app: Scan and store receipts while providing a comprehensive expense overview on the dashboard.
    - [ ] Flutter + Firebase + deployment?
